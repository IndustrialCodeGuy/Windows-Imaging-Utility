...
public static class ImagingPreflight
{
        ...
        string applicationBaseDirectory)
    {
        ...
        {
            return $"Windows Imaging Utility is running from {applicationRoot.TrimEnd('\\')}, which is the selected target partition. " +
        ...
        string applicationBaseDirectory)
    {
        ...
        {
            return $"Windows Imaging Utility is running from Disk {targetDisk.DiskNumber}. The disk hosting the running imaging tools cannot be erased for WIM deployment.";
        }
        ...
        string applicationBaseDirectory)
    {
        ...
        if (applicationDisk?.DiskNumber == targetDisk.DiskNumber)
        {
            return $"Windows Imaging Utility is running from Disk {targetDisk.DiskNumber}. The disk hosting the running imaging tools cannot be overwritten.";
        }
