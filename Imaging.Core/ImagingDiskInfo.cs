...
public sealed class ImagingDiskInfo
{
    ...
    public ImagingDiskStorageInfo StorageInfo { get; init; } = new();
...
public sealed class ImagingPartitionInfo
{
    ...
    public ImagingPartitionStorageInfo StorageInfo { get; init; } = new();
    ...
    public string StableIdentity
    {
        get
        {
            ...
            return $"offset:{StorageInfo.OffsetBytes}";
        }
    }
}
