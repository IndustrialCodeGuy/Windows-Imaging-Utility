...
public sealed class WinReStagingService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            {
                stagingError =
                    "Windows Imaging Utility could not temporarily assign an accessible drive letter to the configured Windows RE partition.\n\n" +
                    assignment.Error;
            }
            else
            {
        ...
        {
            Success = true,
            StagedByWindowsImagingUtility = true,
...
{
    public bool Success { get; init; }
    public bool StagedByWindowsImagingUtility { get; init; }
    ...
    {
        Success = true,
        StagedByWindowsImagingUtility = false,
        WinRePath = path
    };
