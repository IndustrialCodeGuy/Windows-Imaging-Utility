...
public partial class MainForm
{
    ...
    {
        _mPx = WindowsImagingUtilityLayoutMetricsPx.FromDip(_mDip, ScaleDip, ScaleFontPointToPx);
    }
    ...
    private sealed class WindowsImagingUtilityLayoutMetrics
    {
    ...
    private sealed class WindowsImagingUtilityLayoutMetricsPx
    {
        ...
        public static WindowsImagingUtilityLayoutMetricsPx FromDip(WindowsImagingUtilityLayoutMetrics dip, Func<int, int> scale, Func<float, float> scaleFont)
        {
            ...
            return new WindowsImagingUtilityLayoutMetricsPx
            {
