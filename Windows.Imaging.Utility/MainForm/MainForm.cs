...
public partial class MainForm : Form
{
    ...
    private bool _systemSleepRequestActive;
    ...
    private readonly WindowsImagingUtilityLayoutMetrics _mDip = new();
    private WindowsImagingUtilityLayoutMetricsPx _mPx = null!;
    ...
    public MainForm()
    {
        ...
        Text = "Windows Imaging Utility";
        Icon = WindowsIconProvider.CreateApplicationIcon() ?? Icon;
        ...
        InitializeStorageChangeMonitoring(uiContext);
    ...
    protected override void Dispose(bool disposing)
    {
        if (disposing)
        {
            ...
            if (_systemSleepRequestActive)
            {
                WindowsExecutionState.ClearSystemSleepRequest();
                _systemSleepRequestActive = false;
            }

            DisposeStorageChangeMonitoring();
    ...
    private bool TryBeginOperation(string operationName, ImagingDiskInfo? disk = null)
    {
        ...
        if (started)
        {
            _systemSleepRequestActive = WindowsExecutionState.TryPreventSystemSleep();
