...
internal sealed class WimCaptureMetadataDialog : Form
{
    private readonly TextBox _name;
    private readonly TextBox _description;

    public WimCaptureMetadataDialog(string defaultName)
    {
        Text = "Capture WIM";
        ...
        ok.Click += (_, _) =>
        {
            ...
            {
                MessageBox.Show(this, "An image name is required by DISM.", "Capture WIM", MessageBoxButtons.OK, MessageBoxIcon.Warning);
